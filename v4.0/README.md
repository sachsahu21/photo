...
Image Scanner v4.0 scans photos/videos, extracts metadata, detects duplicates, and organizes your media into date-based folders with Excel reporting.
